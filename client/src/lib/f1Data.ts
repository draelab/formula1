...
export const TEAM_CAR_IMAGES: Record<string, string> = {
  Mercedes: carPhoto("mercedes"),
  Ferrari: carPhoto("ferrari"),
  McLaren: carPhoto("mclaren"),
  "Red Bull Racing": carPhoto("redbullracing"),
  Haas: carPhoto("haasf1team"),
  "Racing Bulls": carPhoto("racingbulls"),
  Audi: carPhoto("audi"),
  Alpine: carPhoto("alpine"),
  Williams: carPhoto("williams"),
  Cadillac: carPhoto("cadillac"),
  "Aston Martin": carPhoto("astonmartin"),
};
